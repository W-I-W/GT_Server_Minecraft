...
**Full Changelog**: https://github.com/GTNewHorizons/AE2FluidCraft-Rework/compare/1.3.50-gtnh...1.4.40-gtnh-pre
>## What's Changed
...
> * Fix an issue that GT and AE2FC fluids could not be used with Creative Fluid Cell by @Kogepan229 in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/271 (1.4.35-gtnh-pre, 1.4.34-gtnh)
...
> * Read NBT tags `combine` and `beSubstitute` from `ItemStack` when converting them to `FluidPattern` by @TwoDCube in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/268 (1.4.31-gtnh-pre, 1.4.30-gtnh)
...
> * Fix NPE caused by Level Maintainer by @lailani-f in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/259 (1.4.20-gtnh-pre)
...
> * Prevent Universal Wireless crafting terminal void items. by @lordIcocain in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/254 (1.4.9-gtnh-pre, 1.4.8-gtnh)
...
> * Change default texture name and add new texture by @EnderProyects in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/251 (1.4.3-gtnh-pre)
> * Add Fluid Void Cell by @lordIcocain in https://github.com/GTNewHorizons/AE2FluidCraft-Rework/pull/234 (1.4.3-gtnh-pre, 1.4.2-gtnh)
...
**Full Changelog**: https://github.com/GTNewHorizons/Angelica/compare/1.0.0-beta29...1.0.0-beta40
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/compare/rv3-beta-478-GTNH...rv3-beta-569-GTNH-pre
>## What's Changed
...
> * Fix mouse click coordinate calculation on Interface Terminal by @Kogepan229 in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/693 (rv3-beta-559-GTNH-pre)
> * change network energy storage display to infinity when it is so by @Glease in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/696 (rv3-beta-559-GTNH-pre)
...
> * Add Void and Distribution card for cells and increase card limit for cells by @lordIcocain in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/655 (rv3-beta-524-GTNH-pre, rv3-beta-523-GTNH)
...
> * Add Superluminal Acceleration Card for IOPort by @lordIcocain in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/617 (rv3-beta-510-GTNH-pre)
> * Improve missing mode. by @lordIcocain in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/627 (rv3-beta-510-GTNH-pre)
...
> * Feature: option to hide "stored" items in ae2 crafting plan by @lordIcocain in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/620 (rv3-beta-506-GTNH-pre, rv3-beta-505-GTNH)
...
**Full Changelog**: https://github.com/GTNewHorizons/Baubles-Expanded/compare/2.0.3...2.1.6-GTNH
...
**Full Changelog**: https://github.com/GTNewHorizons/BetterQuesting/compare/3.6.22-GTNH...3.7.4-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Binnie/compare/2.4.4...2.5.5-pre
>## What's Changed
> * Isolator crash fix revision by @Astatine5985 in https://github.com/GTNewHorizons/Binnie/pull/56 (2.5.4)
> * Yeet custom config in favor of NHLib by @ah-OOG-ah in https://github.com/GTNewHorizons/Binnie/pull/53 (2.5.3-pre)
> * Add Localization, Fix Carpentry Hammer / Master Carpentry Hammer Names being reverse by @glowredman in https://github.com/GTNewHorizons/Binnie/pull/57 (2.5.3-pre)
...
**Full Changelog**: https://github.com/GTNewHorizons/BlockRenderer6343/compare/1.2.16...1.3.5-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/BloodArsenal/compare/1.3.5...1.4.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/BloodMagic/compare/1.6.9...1.7.6-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Botania/compare/1.11.6-GTNH...1.12.7-GTNH-pre
>## What's Changed
...
> * Predicate refactoring, attempts at preventing chunk loading by @YannickMG in https://github.com/GTNewHorizons/Catwalks-2/pull/17 (2.3.5-GTNH-pre)
>

# Updated Chisel (2.15.5-GTNH -->  2.16.2-GTNH)
**Full Changelog**: https://github.com/GTNewHorizons/Chisel/compare/2.15.3-GTNH...2.16.2-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/CookingForBlockheads/compare/1.3.8-GTNH...1.4.3-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Crops-plus-plus/compare/1.7.13...1.8.10
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Darkerer/commits/1.0.4

# Updated Draconic-Evolution (1.3.17-GTNH -->  1.4.11-GTNH-pre)
**Full Changelog**: https://github.com/GTNewHorizons/Draconic-Evolution/compare/1.3.17-GTNH...1.4.11-GTNH-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Electro-Magic-Tools/compare/1.5.16...1.6.3
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/EnderIO/compare/2.8.22...2.9.6
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/EnhancedLootBags/compare/1.1.1...1.2.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Et-Futurum-Requiem/commits/2.6.2.5-GTNH
>## What's Changed
> * update build-and-test.yml by @Caedis in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/1 (2.6.2.1-GTNH-pre)
> * Update build.gradle by @Caedis in https://github.com/GTNewHorizons/Et-Futurum-Requiem/pull/2 (2.6.2.1-GTNH-pre)
>

# Updated FloodLights (1.4.6 -->  1.5.3)
**Full Changelog**: https://github.com/GTNewHorizons/FloodLights/compare/1.4.2...1.5.3
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ForestryMC/compare/4.9.19...4.10.5
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ForgeRelocation/compare/0.2.1...0.3.1
...
**Full Changelog**: https://github.com/GTNewHorizons/GT5-Unofficial/compare/5.09.50.103...5.09.51.226-pre
>## What's Changed
...
> * Enable power panel functionality for godforge modules by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4114 (5.09.51.204-pre)
> * Fix merge conflicts by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4116 (5.09.51.204-pre)
> * Fix BlockRenderer6343 hatch face culling by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4095 (5.09.51.204-pre)
> * Fix/hazard api by @YannickMG in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4107 (5.09.51.204-pre)
...
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4075 (5.09.51.201-pre)
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4076 (5.09.51.201-pre)
...
> * Fix Antimatter Sequencer Tricoder info showing wrong information. by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4101 (5.09.51.196-pre)
> * Require sneaking to place cover on pipes, wires and frame boxes by @YannickMG in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4104 (5.09.51.196-pre)
> * Hazard protection API by @2ndDerivative in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4102 (5.09.51.196-pre)
> * Fix Degasser Scanner Info Bug by @ReignOfFROZE in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4106 (5.09.51.196-pre)
...
> * Allow SLAM to be built faster with Hologram Projector by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4090 (5.09.51.193-pre)
> * Localization of additional tooltips by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4093 (5.09.51.193-pre)
> * Stop ME input bus from pushing/allowing pulling by @jurrejelle in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4082 (5.09.51.193-pre)
> * Fix efficiency not going down after disabling the multiblock by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4086 (5.09.51.193-pre)
> * Adding Proper Batch, Mask Parallel & Adjusting Focus Bus on Beamline by @TheEpicGamer274 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4036 (5.09.51.193-pre)
> * New Later Recipe for Rhugnor by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4091 (5.09.51.193-pre)
> * Fix AL recipe packet NPE on world load by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4094 (5.09.51.193-pre)
...
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4075 (5.09.51.190-pre)
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4076 (5.09.51.190-pre)
...
> * add half mode to power transformers by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4080 (5.09.51.186-pre)
> * Remove BW Pair class by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4071 (5.09.51.186-pre)
> * Fix Flask Configurator not allowing values above 32767 by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4087 (5.09.51.186-pre)
...
> * Fix pipe dupe by @jurrejelle in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4083 (5.09.51.184-pre)
> * Fix tectech EnderFluidLink cover ghost loading by @Georggi in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4084 (5.09.51.184-pre)
...
> * Fix PA parallels being locked to 1 by @S4mpsa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4077 (5.09.51.182-pre)
> * Decrement single-use screwdriver on circuit change by @jurrejelle in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4081 (5.09.51.182-pre)
> * fix crowbar train reversing/boosting compatibility by @2ndDerivative in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4079 (5.09.51.182-pre)
...
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4075 (5.09.51.180-pre)
> * Spotless apply for branch Netherite for #4074 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4076 (5.09.51.180-pre)
...
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3974 (5.09.51.177-pre)
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4043 (5.09.51.177-pre)
> * Spotless apply for branch soundChannels for #4059 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4060 (5.09.51.177-pre)
...
> * Fix ZPM Hull Recycling by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4050 (5.09.51.172-pre)
> * migrate fusion recipe startup energy thresholds to use long by @Glease in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4047 (5.09.51.172-pre)
> * Add recipes for tiny GTPP pipes by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4044 (5.09.51.170-pre)
> * Fix non gt item covers not working when sneaking by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4045 (5.09.51.170-pre)
> * Localization of item tooltips by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4040 (5.09.51.170-pre)
> * Added the ability to filter outputs to ME Output Bus and Hatch by @Diamantino-Op in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3828 (5.09.51.170-pre)
> * Spotless apply for branch feature/fusion-long for #4047 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4049 (5.09.51.170-pre)
...
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3974 (5.09.51.168-pre)
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4043 (5.09.51.168-pre)
...
> * Localization 250303 by @Discreater in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4019 (5.09.51.163-pre)
> * Re-enable wire up and down crafting for lategame wires by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3997 (5.09.51.163-pre)
> * Fix level8 Purification Unit not consume ME inputs on successful catalyst insertion by @reobf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4010 (5.09.51.163-pre)
> * Better handle capacityless fluid containers by @YannickMG in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4015 (5.09.51.163-pre)
> * Take DTPF catalyst discount into account on recipecheck by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/4006 (5.09.51.163-pre)
...
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3974 (5.09.51.158-pre)
...
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3974 (5.09.51.154-pre)
...
> * Add Dynamo Hatches to Naqfuel Refinery by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3972 (5.09.51.151-pre, 5.09.51.150)
> * Spotless apply for branch feature/overlay for #3973 by @github-actions in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3974 (5.09.51.149-pre)
...
> * Data stick left click on crafting proxy support by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3908 (5.09.51.125-pre)
> * Resolver hatch shift method rewrite by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3914 (5.09.51.125-pre)
> * drop input bus compat for eec by @Pxx500 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3900 (5.09.51.125-pre)
> * Fix yothatches spamming large network packets (while terminal open) when there is a lot of fluid movement by @kuba6000 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3911 (5.09.51.125-pre)
> * Add Waila info and Data Stick compatibility to the Cloud Computation Hatch by @purebluez in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3917 (5.09.51.125-pre)
> * Let radio hatches be machine controllable by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3916 (5.09.51.125-pre)
> * Lower fluid for solidifying rounds from 18L to 16L by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3920 (5.09.51.125-pre)
> * Add a MultiAmp-only hatch identifier by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3919 (5.09.51.125-pre)
> * Improve how/when Crop Manager applies Weed-EX by @SchoofsKelvin in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3915 (5.09.51.125-pre)
> * Prevent IC2 rubber logs from being rotated by @Caedis in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3923 (5.09.51.125-pre)
> * Remove missed parameter hatch code  by @FrostyFire1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3927 (5.09.51.125-pre)
> * Refactor rock breaker for extensibility by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3921 (5.09.51.125-pre)
> * Fix excessive catalyst usage during convergence if subticking by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3925 (5.09.51.125-pre)
...
> * Add `expediteRecipeCheck` to copy-paste for data sticks and data orbs by @Vlamonster in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3892 (5.09.51.118-pre)
> * Remove invalid CRIBs before use by @reobf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3893 (5.09.51.118-pre)
> * Add gunpowder centrifuging by @LazyFleshWasTaken in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3886 (5.09.51.118-pre)
...
> * Replace Rhugnor with Radox in Compact MK4 Fusion Controller by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3876 (5.09.51.109-pre)
> * Add Pipe Swapping functionality by @mak8427 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3836 (5.09.51.109-pre)
> * Change computation formula in Research Station for scanner mode by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3877 (5.09.51.109-pre)
...
> * Better Assline checkresult by @reobf in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3863 (5.09.51.102-pre)
> * Fix confusing black hole exploit by @FourIsTheNumber in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3864 (5.09.51.102-pre)
...
> * Fix cribusses dupe 2.8 by @lordIcocain in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3859 (5.09.51.98-pre)
> * Rewrite CoAL recipe loader by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3837 (5.09.51.98-pre)
> * Remove deprecated render classes by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3773 (5.09.51.98-pre)
> * Fix `TTUtility.toExponentForm()` throws with smaller inputs by @Taskeren in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3861 (5.09.51.98-pre)
...
> * Deprecate GTLanguageManager by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3853 (5.09.51.94-pre)
> * Consolidate GoodGenerator MTE IDs enum by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3854 (5.09.51.94-pre)
> * Fix: tectech AL recipe adder does not reinit datasticks correctly by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3856 (5.09.51.94-pre)
...
> * Change biolab recipes to be able to use any circuit o the tier and not just the item any circuit of the tier by @Bjdufre1 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3849 (5.09.51.92-pre)
> * Add multi_plate subtag to materials that are used to make gc and dreamcore compressed plates by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3851 (5.09.51.92-pre)
...
> * Remove Old GT++ UI from some multiblocks by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3819 (5.09.51.80-pre, 5.09.51.79)
> * Remove multi-ingot by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3815 (5.09.51.78-pre)
> * Correct tengam for magnetic upgrade in Antimatter forge by @lordIcocain in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3818 (5.09.51.78-pre)
...
> * remove over 1000 recipes that were pure bloat by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3771 (5.09.51.64-pre)
> * Allow name remover to remove muffler upgrades by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3778 (5.09.51.64-pre)
> * Remove GT++ naq fuels by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3783 (5.09.51.64-pre)
> * Combine duplicate Titansteel fluids in UHV charge pack recipe by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3784 (5.09.51.64-pre)
...
> * More batch mode by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3751 (5.09.51.57-pre)
> * remove froth recycling Circuits by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3757 (5.09.51.57-pre)
> * fix HV tank recipes by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3753 (5.09.51.57-pre)
> * Changing name of MBF to MEBF by @CrystieColon3 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3756 (5.09.51.57-pre)
> * Migrate coremod casings to GT5u by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3732 (5.09.51.57-pre)
> * add MBF abbreviation in Tooltip by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3755 (5.09.51.57-pre)
...
> * Fix goodgen controller textures missing by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3723 (5.09.51.37-pre)
> * Move MTE IDs around by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3725 (5.09.51.37-pre)
> * Fix crash on serializing space teams by @lordIcocain in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3726 (5.09.51.37-pre)
...
> * Updates Structure checks to add error hinting by @kstvr32 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3254 (5.09.51.34-pre)
> * Add separate minimum & default tick rates for covers by @S4mpsa in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3722 (5.09.51.34-pre)
> * Disable wirecutter interaction on EOH when it's working by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3710 (5.09.51.34-pre)
> * Matter manipulator compat by @RecursivePineapple in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3222 (5.09.51.34-pre)
...
> * Move beamline multis to checkProcessing() by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3696 (5.09.51.32-pre)
> * THTR by @purebluez in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3699 (5.09.51.32-pre)
> * Removed usage of deprecated API in LES by @CrystieColon3 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3702 (5.09.51.32-pre)
...
> * Wireless energy covers by @GDCloudstrike in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3701 (5.09.51.28-pre)
> * Fixes for dyson galaxyspace to intergalactic migration by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3700 (5.09.51.28-pre)
> * Removed usage of deprecated API in LES by @CrystieColon3 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3702 (5.09.51.28-pre)
...
> * THTR by @purebluez in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3699 (5.09.51.26-pre)
> * Buff PCB Parallel by @StaffiX in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3692 (5.09.51.25-pre)
> * Move beamline multis to checkProcessing() by @serenibyss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3696 (5.09.51.25-pre)
...
> * Add Chemical Bath + Thermal Centrifuge mode to IOF by @Nockyx in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3539 (5.09.51.19-pre, 5.09.51.18)
> * fix Space Project NEI GUI by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/3687 (5.09.51.17-pre, 5.09.51.16)
...
**Full Changelog**: https://github.com/GTNewHorizons/GTNH-Intergalactic/compare/1.4.30...1.5.39
>## What's Changed
...
> * Add mining drone controller slot by @jurrejelle in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/116 (1.5.37)
...
> * Fix SE mining module item consumption by @GDCloudstrike in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/109 (1.5.30)
> * Disable optimization for Space Mining recipemap by @StaffiX in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/108 (1.5.29)
...
> * Remove usages of deprecated render classes by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/99 (1.5.19-pre, 1.5.18)
> * Clean up code before merge by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/93 (1.5.16)
> * Add Localizations by @glowredman in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/97 (1.5.15-pre, 1.5.12)
> * Fix dyson tooltip by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/95 (1.5.11-pre)
> * Add "supports tectech hatches" tooltip to elevator and dyson by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/96 (1.5.11-pre)
> * Fix dyson tooltip by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/95 (1.5.10)
> * Add "supports tectech hatches" tooltip to elevator and dyson by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/96 (1.5.10)
> * Add Mk4, Mk5 plasmas to space miner and rebalance plasma boosting by @StaffiX in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/94 (1.5.8)
...
> * Move space miner to RA2 by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/81 (1.5.5)
> * Fix space miner asteroid selection by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/92 (1.5.5)
> * Add asteroid summary and cache/improve recipe lookup for space mining by @hacatu in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/76 (1.5.4)
> * Fix multi ui text position by @HoleFish in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/91 (1.5.2)
> * Remove Space Elevator chunk loading by @serenibyss in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/90 (1.5.1)
> * Disable space assembler recipe optimization by @GDCloudstrike in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/88 (1.5.0)
>

# Updated GTNHLib (0.5.23 -->  0.6.17)
**Full Changelog**: https://github.com/GTNewHorizons/GTNHLib/compare/0.5.23...0.6.17
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Gadomancy/compare/1.3.6...1.4.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Galacticraft/compare/3.2.9-GTNH...3.3.5-GTNH
>## What's Changed
...
# Updated Galaxy-Space-GTNH (1.1.99-GTNH -->  1.1.110-GTNH-pre)
**Full Changelog**: https://github.com/GTNewHorizons/Galaxy-Space-GTNH/compare/1.1.97-GTNH...1.1.110-GTNH-pre
>## What's Changed
...
> * Optimize enceladus worldgen by @RecursivePineapple in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/123 (1.1.103-GTNH-pre, 1.1.102-GTNH)
...
**Full Changelog**: https://github.com/GTNewHorizons/Gravitation-Suite-Neo/compare/1.2.2...1.3.3
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Hodgepodge/compare/2.5.82...2.6.14
>## What's Changed
> * Backport instant bed spawn setting by @Caedis in https://github.com/GTNewHorizons/Hodgepodge/pull/473 (2.6.14)
> * Fix skin manager leaking client world by @Glease in https://github.com/GTNewHorizons/Hodgepodge/pull/469 (2.6.14-pre)
...
> * Fix coretweaks hard-dep by @Lyfts in https://github.com/GTNewHorizons/Hodgepodge/pull/460 (2.6.10-pre)
> * fix getFloatTemperature causing lag by @Lyfts in https://github.com/GTNewHorizons/Hodgepodge/pull/461 (2.6.10-pre)
...
**Full Changelog**: https://github.com/GTNewHorizons/Infernal-Mobs/compare/1.9.1-GTNH...1.10.1-GTNH-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/InventoryBogoSorter/commits/1.2.30-GTNH
>## What's Changed
...
> * Compat by @0hwx in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/34 (1.2.10-GTNH-pre)
...
> * Spotless apply for branch Merging-Mousetweaks for #28 by @github-actions in https://github.com/GTNewHorizons/InventoryBogoSorter/pull/29 (1.2.4-GTNH-pre)
...
# Updated Jabba (1.4.7 -->  1.5.3)
**Full Changelog**: https://github.com/GTNewHorizons/Jabba/compare/1.4.6...1.5.3
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/LogisticsPipes/compare/1.3.4-GTNH...1.4.4-GTNH-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/MatterManipulator/commits/0.0.25-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ModularUI2/compare/2.1.16-1.7.10...2.2.6-1.7.10
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Natura/compare/2.7.5...2.8.4-pre
>## What's Changed
...
> * Merge itemstacks in some assline recipes 2/3 by @FrostyFire1 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1214 (2.7.126-pre)
...
> * RC Firestone for LV Age by @Dream-Master in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1207 (2.7.118-pre, 2.7.117)
...
> * Don't assume block and item IDs don't change at map load by @YannickMG in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1183 (2.7.80-pre, 2.7.79)
...
> * Asgardandelion 2.0 by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1179 (2.7.76-pre, 2.7.75)
...
> * Fix duplicate solar conversion by @FourIsTheNumber in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1176 (2.7.67-pre)
> * Replace direct references to IC2 item casings with calls to GTOreDictUnificator by @C0bra5 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1175 (2.7.67-pre)
> * Fix loop between Optical Processor and Tier 3.5 Memory by @EnderProyects in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1174 (2.7.67-pre)
...
> * Remove map recipe from crafting and recipe removal logic by @SarcasticMax in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1168 (2.7.61-pre, 2.7.60)
> * Remove iridium plate recipe from double ingot by @StaffiX in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1166 (2.7.58-pre, 2.7.57)
...
> * Remove hot mv sc circuit 1 by @Yoshy2002 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1155 (2.7.48-pre)
> * fix recipe of Logistics Disk by @Yoshy2002 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1154 (2.7.48-pre)
> * GCPlanets recipe cleanup by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1151 (2.7.48-pre)
> * Add NC hatch recipes by @GDCloudstrike in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1152 (2.7.48-pre)
...
> * Add assembler recipes for steam hulls by @serenibyss in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1146 (2.7.44-pre, 2.7.43)
...
> * Hatch/bus type change shaped to shapeless by @Pxx500 in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1132 (2.7.32-pre, 2.7.31)
...
> * Fix DS Parts Recipes by @glowredman in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1128 (2.7.23-pre, 2.7.22)
> * Fix UEV+ casing and hull recycling recipes by @serenibyss in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1127 (2.7.21-pre, 2.7.20)
...
> * Fix artificial universe cell recipes by @GDCloudstrike in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1118 (2.7.13-pre, 2.7.12)
> * Nerf glass loop  by @GDCloudstrike in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/1113 (2.7.9-pre, 2.7.8)
...
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughItems/compare/2.6.51-GTNH...2.7.37-GTNH-pre
>## What's Changed
...
> * Change Permutation Filter by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/598 (2.7.27-GTNH, 2.7.27)
...
> * Fix NPE in ItemsTooltipLineHandler by @Caedis in https://github.com/GTNewHorizons/NotEnoughItems/pull/589 (2.7.17-GTNH-pre)
> * fix memory leak fixes not working for MP by @Glease in https://github.com/GTNewHorizons/NotEnoughItems/pull/590 (2.7.17-GTNH-pre)
...
> * Change OptionIntegerField Width by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/575 (2.7.9-GTNH-pre)
> * Add RenderTooltipEvent Compat by @glowredman in https://github.com/GTNewHorizons/NotEnoughItems/pull/574 (2.7.9-GTNH-pre)
...
> * Add Space Mode Settings to Search by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/571 (2.7.5-GTNH-pre, 2.7.4-GTNH)
> * Fix Accept Folowing for custom recipe handlers by @slprime in https://github.com/GTNewHorizons/NotEnoughItems/pull/570 (2.7.3-GTNH-pre, 2.7.2-GTNH)
...
**Full Changelog**: https://github.com/GTNewHorizons/Nutrition/compare/0.0.13...0.1.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OpenComputers/compare/1.10.27-GTNH...1.11.12-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OpenModularTurrets/compare/2.3.6...2.4.3
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ProjectRed/compare/4.11.0-GTNH...4.11.2-GTNH-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Railcraft/compare/9.15.15...9.16.8-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Salis-Arcana/commits/1.1.10-GTNH

# Updated Schematica (1.12.2-GTNH -->  1.12.5-GTNH-pre)
Mod is client-side only.
...
**Full Changelog**: https://github.com/GTNewHorizons/ServerUtilities/compare/2.1.7...2.1.36-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StructureLib/compare/1.3.6...1.4.6
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/TCNEIAdditions/compare/1.4.2...1.4.7-pre

# Updated TX-Loader (1.7.3 -->  1.8.4)
Mod is client-side only.
**Full Changelog**: https://github.com/GTNewHorizons/TX-Loader/compare/1.7.2...1.8.4
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBases/compare/1.7.7...1.8.5-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBoots/compare/1.3.10...1.4.4
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicEnergistics/compare/1.6.27-GTNH...1.7.6-GTNH
>## What's Changed
...
> * Correct the spelling of matrixs to matrices and counting of them for the Infusion Provider by @Worive in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/79 (1.7.1-GTNH-pre, 1.7.0-GTNH)
>

# Updated ThaumicHorizons (1.7.0 -->  1.7.2-pre)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicHorizons/compare/1.7.0...1.7.2-pre
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicTinkerer/compare/2.10.2...2.11.7
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/TinkersConstruct/compare/1.12.16-GTNH...1.13.13-GTNH
>## What's Changed
...
> * Localization of drying rack nei recipe handler by @Discreater in https://github.com/GTNewHorizons/TinkersConstruct/pull/156 (1.13.12-GTNH-pre)
> * Change Rank Duration Localization key by @slprime in https://github.com/GTNewHorizons/TinkersConstruct/pull/157 (1.13.12-GTNH-pre)
...
**Full Changelog**: https://github.com/GTNewHorizons/VisualProspecting/compare/1.3.28...1.4.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/WitchingGadgets/compare/1.5.17-GTNH...1.7.0-GTNH
>## What's Changed
...
> * Spotless apply for branch Ethryan-Patch for #62 by @github-actions in https://github.com/GTNewHorizons/WitchingGadgets/pull/66 (1.5.18-GTNH-pre)
>
...
**Full Changelog**: https://github.com/GTNewHorizons/ae2stuff/compare/0.8.5-GTNH...0.9.4-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/harvestcraft/compare/1.2.3-GTNH...1.3.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/lwjgl3ify/compare/2.1.9...2.1.11
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/twilightforest/compare/2.6.35...2.7.5
>## What's Changed
...
# Credits
Special thanks to @0hwx, @2ndDerivative, @48a3efa65c881ef567345b17f3910e06, @54M44R, @AbdielKavash, @Ableytner, @ah-OOG-ah, @Akeianova, @Alexdoru, @amyavi, @Andthehand, @Apeiria01, @asiekierka, @Astatine5985, @AzodFR, @benjamin-kirkbride, @Bjdufre1, @BlueHero233, @bluhbipo, @boubou19, @brandyyn, @Breviel, @C-Remilian, @C0bra5, @Caedis, @calreveraster, @Cardinalstars, @charagarlnad, @chochem, @ChrisJStone, @ChromaPIE, @ClassixX, @Cleptomania, @combusterf, @Connor-Colenso, @CookieBrigade, @CrystieColon3, @Csstform, @DarkShadow44, @DCNick3, @Demiu, @Diamantino-Op, @dibbydoda, @Dioxop, @Discreater, @Dream-Master, @DrParadox7, @DylanTaylor1, @eigenraven, @Eldrinn-Elantey, @Elisis, @embeddedt, @EmperorSuper, @EnderProyects, @Eraldoe, @Ethryan, @Fabboz, @FourIsTheNumber, @FrostyFire1, @GDCloudstrike, @Georggi, @giantcavespider, @github-actions, @Glease, @glowredman, @godrja, @guid118, @hacatu, @hiroscho, @HoleFish, @huihiuhuai, @iamcsharper, @ihfuhgljclhflhc, @Impos913, @jude123412, @Juknum, @jurrejelle, @Keridos, @Kogepan229, @koolkrafter5, @Kortako, @kstvr32, @kuba6000, @kumquat-ir, @kurrycat2004, @lailani-f, @LazyFleshWasTaken, @leumasme, @lordIcocain, @lucythebean, @Lyfts, @mak8427, @Maratons4, @MathiasDeWeerdt, @MCTBL, @MeiTianyou, @MellowArpeggiation, @miaowwwwww, @michaeldoylecs, @Midnight145, @miozune, @MissBismuth, @mitchej123, @mM4ri, @Nockyx, @NotAPenguin0, @nshepperd, @OBlankenship, @OmdaCZ, @paulzzh, @Pilzinsel64, @POPlol333, @purebluez, @Pxx500, @Quarri6343, @querns, @Rafadaz, @RecursivePineapple, @ReignOfFROZE, @reobf, @Ruling-0, @S4mpsa, @SafariXiu, @Sanduhr32, @SarcasticMax, @SchoofsKelvin, @serenibyss, @Shadow1590, @shadoxxhd, @slprime, @spacebuilder2020, @StaffiX, @szuend, @Taskeren, @TheEpicGamer274, @TotallyNotOndre, @TwoDCube, @Viptunbeqwfwew, @Vlamonster, @wlhlm, @Worive, @xronin01, @YamiKami-Sama, @YannickMG, @Yoshy2002, @zhehedream, @Zorbatron, for their code contributions listed above, and to everyone else who helped, including all of our beta testers! <3